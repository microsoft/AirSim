...
# -----------------------------------  Common vehicle APIs ---------------------------------------------
    ...
    def simGetCameraInfo(self, camera_id, vehicle_name = ''):
        return CameraInfo.from_msgpack(self.client.call('simGetCameraInfo', camera_id, vehicle_name))
    def simSetCameraOrientation(self, camera_id, orientation, vehicle_name = ''):
        self.client.call('simSetCameraOrientation', camera_id, orientation, vehicle_name)
