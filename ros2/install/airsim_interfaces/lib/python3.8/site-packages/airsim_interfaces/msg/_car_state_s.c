...
bool airsim_interfaces__msg__car_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.msg._car_state.CarState", full_classname_dest, 41) == 0);
  }
  airsim_interfaces__msg__CarState * ros_message = _ros_message;
  {  // header
  ...
  {  // maxrpm
    PyObject * field = PyObject_GetAttrString(_pymsg, "maxrpm");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->maxrpm = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // handbrake
...
PyObject * airsim_interfaces__msg__car_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("airsim_interfaces.msg._car_state");
  ...
  {  // maxrpm
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->maxrpm);
    {
      int rc = PyObject_SetAttrString(_pymessage, "maxrpm", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
