...
bool airsim_interfaces__msg__gps_yaw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("airsim_interfaces.msg._gps_yaw.GPSYaw", full_classname_dest, 37) == 0);
  }
  airsim_interfaces__msg__GPSYaw * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of GPSYaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("airsim_interfaces.msg._gps_yaw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GPSYaw");
