...
{
  airsim_interfaces__srv__TakeoffGroup_Request * msg = (airsim_interfaces__srv__TakeoffGroup_Request *)malloc(sizeof(airsim_interfaces__srv__TakeoffGroup_Request));
  if (!msg) {
    return NULL;
  }
...
airsim_interfaces__srv__TakeoffGroup_Request__Sequence__init(airsim_interfaces__srv__TakeoffGroup_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (airsim_interfaces__srv__TakeoffGroup_Request *)calloc(size, sizeof(airsim_interfaces__srv__TakeoffGroup_Request));
    if (!data) {
      return false;
    }
...
{
  airsim_interfaces__srv__TakeoffGroup_Request__Sequence * array = (airsim_interfaces__srv__TakeoffGroup_Request__Sequence *)malloc(sizeof(airsim_interfaces__srv__TakeoffGroup_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  airsim_interfaces__srv__TakeoffGroup_Response * msg = (airsim_interfaces__srv__TakeoffGroup_Response *)malloc(sizeof(airsim_interfaces__srv__TakeoffGroup_Response));
  if (!msg) {
    return NULL;
  }
...
airsim_interfaces__srv__TakeoffGroup_Response__Sequence__init(airsim_interfaces__srv__TakeoffGroup_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (airsim_interfaces__srv__TakeoffGroup_Response *)calloc(size, sizeof(airsim_interfaces__srv__TakeoffGroup_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  airsim_interfaces__srv__TakeoffGroup_Response__Sequence * array = (airsim_interfaces__srv__TakeoffGroup_Response__Sequence *)malloc(sizeof(airsim_interfaces__srv__TakeoffGroup_Response__Sequence));
  if (!array) {
    return NULL;
  }
