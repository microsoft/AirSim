...
在2017年，微软研究院创建了AirSim作为AI研究和实验的平台。在五年的时间里，这个研究项目达到了它的目的——并取得了很大的进展——成为共享研究代码和测试新想法在空中AI开发和模拟方面的一个常见方式。此外，时间推动了我们将技术应用于现实世界的方式的进步，特别是在空中出行和自动化系统方面。例如，无人机配送不再是科幻故事——它已成为商业现实，这意味着有新的需求需要满足。在这个过程中我们学到了很多，我们想感谢这个社区一路上的参与。
