...
int
SerialPort::setAttributes(int baudRate, Parity parity, int dataBits, StopBits bits, Handshake hs, int readTimeout, int writeTimeout)
{
    DCB dcb;
...
int
SerialPort::setAttributes(int baudRate, Parity parity, int dataBits, StopBits stopBits, Handshake handshake, int readTimeout, int writeTimeout)
{
...
void SerialPort::setSpeed(int baudRate)
{
    speed_t value = B0;
    switch (baudRate)
    {
