...
2. Press the Windows key, type "powershell" (without quotes), right-click the resulting PowerShell application icon, and click "Run as administrator"
3. cd AirSim
4. rm -r Unreal/Plugins/AirSim/Source/AirLib
5. rm -r Unreal/Environments/Blocks/Plugins/AirSim
6. cd Unreal/Environments/Blocks
7. ./setUpLinks.bat
