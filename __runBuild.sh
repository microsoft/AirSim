...
# TODO: Change to move AirLib to the blocks environment, since we are only using 1
#rsync -a --delete AirLib Unreal/Plugins/AirSim/Source
rsync -a --delete AirLib Unreal/Environments/Blocks/Plugins/AirSim/Source
#rm -rf Unreal/Plugins/AirSim/Source/AirLib/src
rm -rf Unreal/Environments/Blocks/Plugins/AirSim/Source/AirLib/src
...
# Update Plugins file
rsync -a --delete Unreal/Environments/Blocks/Plugins/AirSim Unreal/Plugins
