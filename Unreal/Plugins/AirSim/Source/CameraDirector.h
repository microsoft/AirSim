...
public:
    ...
    void initializeForBeginPlay(ECameraDirectorMode view_mode, VehicleSimApi* vehicle_pawn_wrapper, APIPCamera* external_camera);

    void setCameras(APIPCamera* external_camera, VehicleSimApi* vehicle_pawn_wrapper);
