...
STRICT_MODE_ON
#include "rpc/RpcLibAutomobileServer.hpp"
...
namespace msr { namespace airlib {
...

	{
		...
		pimpl_->server.bind("getImageFromCamera", [&]() -> vector<uint8_t> {
	...
	vector<uint8_t> RpcLibAutomobileServer::getImageFromCamera()
	{
		auto result = vector<uint8_t>();
		result = vehicle_controller_->getImageFromCamera(0, VehicleCamera::ImageType::Scene);
		return result;
	}
