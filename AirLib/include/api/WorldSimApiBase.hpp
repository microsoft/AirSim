...
namespace airlib
{
    ...
    public:
        ...
        virtual string spawnObject(const string& object_name, const string& load_component, const Pose& pose, const Vector3r& scale, bool physics_enabled, bool is_blueprint) = 0;
